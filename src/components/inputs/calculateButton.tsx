...
export default function ContainedButtons() {
  return (
    <Button
      ...
      onClick={() => {
        CalculationOptions = {
          type: CalculationOptionsType.type,
          options: CalculationOptionsCheckboxes,
          measurementPeriodStart: CalculationOptionsMeasurementStart,
          measurementPeriodEnd: CalculationOptionsMeasurementEnd
        };
